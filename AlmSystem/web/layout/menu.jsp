        ...
        <nav class="sidebar sidebar-open">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link"
                                        href="funcionario/salvar.jsp"> <i class="oi oi-plus"></i> <span>Cadastrar</span>
                    </a></li>
                <li class="nav-item"><a class="nav-link"
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" 
                                        href="${pageContext.request.contextPath}/DadosItens?origem=salvar"> <i class="oi oi-plus"></i> <span>Cadastrar Item</span>
                    </a></li>
                <li class="nav-item"><a class="nav-link" 
                     ...
                     <li class="nav-item"><a class="nav-link" 
                                        href="${pageContext.request.contextPath}/DadosItens?origem=relatorio"> <i
                            class="oi oi-spreadsheet"></i> <span>Relatorios</span>
                </a></li>
